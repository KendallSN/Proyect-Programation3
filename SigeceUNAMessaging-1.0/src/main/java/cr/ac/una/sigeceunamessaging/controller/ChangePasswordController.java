...
@Override
    ...
    private void onActionBtnConfirm(ActionEvent event) {
        if(this.txtPassword.getText().isEmpty()||this.txtConfirmPassword.getText().isEmpty()){
            ...
            try {   
//                UserDto userDto=LoginController.loggedUser;
                ...
                Logger.getLogger(ChatController.class.getName()).log(Level.SEVERE, "An error ocurred while changing the password.", ex);
