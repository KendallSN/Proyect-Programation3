 ...
 * 2024-10-31T16:00:38.058-06:00
 * Generated source version: 4.0.2
 *
 */
@WebServiceClient(name = "UserController",
                  wsdlLocation = "http://localhost:8080/SigeceUNASecurityWs/UserController?wsdl",
                  targetNamespace = "http://controller.sigeceunasecurityws.una.ac.cr/")
public class UserController_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://controller.sigeceunasecurityws.una.ac.cr/", "UserController");
    public final static QName UserControllerPort = new QName("http://controller.sigeceunasecurityws.una.ac.cr/", "UserControllerPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/SigeceUNASecurityWs/UserController?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserController_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/SigeceUNASecurityWs/UserController?wsdl");
        }
        WSDL_LOCATION = url;
    }
