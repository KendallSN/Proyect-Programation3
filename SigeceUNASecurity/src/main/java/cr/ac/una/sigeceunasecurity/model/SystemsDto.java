...
public class SystemsDto{
    ...
    public SystemsDto(cr.ac.una.sigeceunasecurityws.controller.SystemsDto system) {
        this.systId=new SimpleStringProperty();
        this.systId.set(system.getSystId().toString());
        this.systVersion=system.getSystVersion();
        this.systName=new SimpleStringProperty();
        this.systName.set(system.getSystName());
        this.systDescription=new SimpleStringProperty();
        this.systDescription.set(system.getSystDescription());
        this.asignedRole=new SimpleStringProperty();
        this.asignedRole.set("Sin asignar");
        this.roleCollection= new ArrayList();
    }
    
    public cr.ac.una.sigeceunasecurityws.controller.SystemsDto getSystem(){
        cr.ac.una.sigeceunasecurityws.controller.SystemsDto system= new cr.ac.una.sigeceunasecurityws.controller.SystemsDto();
        system.setSystId(this.getSystId());
        system.setSystVersion(this.systVersion);
        system.setSystName(this.getSystName());
        system.setSystDescription(this.getSystDescription());
        return system;
    }
