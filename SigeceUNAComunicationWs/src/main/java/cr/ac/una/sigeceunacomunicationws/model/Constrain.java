...
@NamedQueries({
    ...
    @NamedQuery(name="Constrain.findByVariable",query="SELECT c FROM Constrain c WHERE c.varId= :varId"),
...
public class Constrain implements Serializable {
    ...
    public  Constrain(ConstrainDto constrainDto){
        this.cnstId=constrainDto.getCnstId();
        update(constrainDto);
    }
    
    public void update(ConstrainDto constrainDto) {
       this.cnstResult=constrainDto.getCnstResult();
       this.cnstSymbol=constrainDto.getCnstSymbol();
       this.cnstVersion=constrainDto.getCnstVersion();
    }
    ...
    public String toString() {
        return "cr.ac.una.sigeceunacomunicationws.model.Constrain[ cnstId=" + cnstId + " ]";
    }
