...
@NamedQueries({
    ...
    @NamedQuery(name="Variable.findByNotificationProcess",query="SELECT v FROM Variable v WHERE v.ntpId =:ntpId"),
...
public class Variable implements Serializable {
    ...
    public  Variable(VariableDto variableDto){
        this.varId=variableDto.getVarId();
        update(variableDto);
    }
    
    public void update(VariableDto variableDto) {
       this.varDefault=variableDto.getVarDefault();
       this.varType=variableDto.getVarType();
       this.varVariable=variableDto.getVarVariable();
       this.varVersion=variableDto.getVarVersion();
    }
    ...
    public String toString() {
        return "cr.ac.una.sigeceunacomunicationws.model.Variable[ varId=" + varId + " ]";
    }
