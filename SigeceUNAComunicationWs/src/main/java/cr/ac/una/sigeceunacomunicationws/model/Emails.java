...
public class Emails implements Serializable {
    ...
    public Emails(EmailsDto emailsDto) {
        this.emlId=emailsDto.getEmlId();
        this.update(emailsDto);
    }
    ...
    public void update(EmailsDto emailsDto) {
        this.emlHtml=emailsDto.getEmlHtml();
        this.emlEmailaddress=emailsDto.getEmlEmailaddress();
        this.emlSent=emailsDto.getEmlSent();
        this.emlSentdate=emailsDto.getEmlSentdate();
        this.emlVersion=emailsDto.getEmlVersion();
        this.fileCollection = new ArrayList<>();
        if(emailsDto.getFileCollection() != null){
            emailsDto.getFileCollection().stream().forEach(e->this.fileCollection.add(new File(e)));
        }
    }
