...
public class Chat implements Serializable {
    ...
    public Chat(ChatDto chat) {
        this.chtId = chat.getChtId();
        this.chtVersion = chat.getChtVersion();
        this.messageCollection = new ArrayList<>();
        for(MessageDto message : chat.getMessageCollection()){
            this.messageCollection.add(new Message(message));
        }
        this.usrIdUser1 = new User(chat.getUsrIdUser1());
        this.usrIdUser2 = new User(chat.getUsrIdUser2());
    }
