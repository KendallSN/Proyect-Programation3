...
public class Notificationprocess implements Serializable {
    ...
    public Notificationprocess(NotificationprocessDto notificationprocess) {
        ...
        for(VariableDto variable : notificationprocess.getVariableCollection()){
            this.variableCollection.add(new Variable(variable));
        }
        this.emailsCollection = new ArrayList<>();
        for(EmailsDto emails : notificationprocess.getEmailsCollection()){
